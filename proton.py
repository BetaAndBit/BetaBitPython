...
def proton(**args):
    """
    The 'proton' function is used for solving problems in the data-based game "The Proton Game". 
    Solve four data-based puzzles in order to crack into Pietraszko's account!
    
    Keyword arguments:
    args -- 'proton' function is called by different arguments, which vary depending on a problem that Bit is trying to solve. See 'Details' in order to learn more about the list of possible arguments.
